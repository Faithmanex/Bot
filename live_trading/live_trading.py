        ...
        for timeframe_name, timeframe in timeframes.items():
            ...
            while True:
                ...
                for strategy_name in strategies:
                    ...
                    plot_df = getattr(strategy, strategy_name)(RR=3)

                    initial_balance = 10000
                    risk_amount = 50
                    risk_type = "fixed"
                    backtest_results_df, wins, losses, neither = backtest(df, plot_df, RR=3, initial_balance=initial_balance, risk_amount=risk_amount, risk_type=risk_type, symbol=symbol
                    )
