    ...
    def AMSstrategy(self, RR):
        ...
        for x in range(self.new_df.shape[0]):
            if (
                ...
                if (
                    current_low < low_2 and high_3 > high_1 and high_1 > low_2
                    and low_4 > low_2 and high_1 > current_low
                    and (low_2 - current_low) > (170 / 100 * (high_1 - low_2))
                ):
                    ...
                    stop_loss = high_5 + (block_range * 1.15)
                    take_profit = entry_price - ((stop_loss - entry_price) * RR)
